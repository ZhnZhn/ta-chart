...
var timeIntervalBarWidth = _chartFns2.default.timeIntervalBarWidth,
    utcDay = _chartFns2.default.utcDay,
    format = _chartFns2.default.format;


var _stroke = function _stroke(d, dPrev) {
  return d.close > dPrev.close ? _config2.default.UP : _config2.default.DOWN;
};

var _fill = function _fill(d, dPrev) {
  return d.close > d.open ? _config2.default.TRANSPARENT : _stroke(d, dPrev);
};
