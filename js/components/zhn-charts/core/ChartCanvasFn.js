...
var resetChart = function resetChart(props) {
  var state = calculateState(props),
      ...
      dimensions = getDimensions(props),
      chartConfig = (0, _ChartDataUtil.getChartConfigWithUpdatedYScales)((0, _ChartDataUtil.getNewChartConfig)(dimensions, children), {
    plotData: plotData,
    xAccessor: xAccessor,
    displayXAccessor: displayXAccessor,
    fullData: fullData
...
var updateChart = function updateChart(newState, initialXScale, props, lastItemWasVisible, initialChartConfig) {
  ...
  if (!lastItemWasVisible || end >= lastXItem) {
    ...
    initialPlotData = _response.plotData; // if last item was visible, then shift
  ...
  var plotData = postCalculator(initialPlotData),
      ...
      chartConfig = (0, _ChartDataUtil.getChartConfigWithUpdatedYScales)(_newChartConfig, {
    plotData: plotData,
    xAccessor: xAccessor,
    displayXAccessor: displayXAccessor,
    fullData: fullData
