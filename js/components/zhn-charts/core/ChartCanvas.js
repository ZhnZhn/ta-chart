...
var ChartCanvas = /*#__PURE__*/function (_React$Component) {
  ...
  function ChartCanvas(_props) {
    ...
    _this.eventCaptureRef = /*#__PURE__*/_react["default"].createRef();
    _this.finalPinch = void 0;
    _this.fullData = void 0;
    ...
    _this.getDataInfo = function () {
      return (0, _extends2["default"])({}, _this.state, {
    ...
    _this.calculateStateForDomain = function (newDomain) {
      var _this$state2 = _this.state,
        ...
        currentDomain: initialXScale.domain()
          ...
          chartConfig = (0, _ChartDataUtil.getChartConfigWithUpdatedYScales)(initialChartConfig, {
        plotData: plotData,
        xAccessor: xAccessor,
    ...
    _this.pinchZoomHelper = function (initialPinch, finalPinch) {
      var initialPinchXScale = initialPinch.xScale,
          ...
          postCalculator = _this.props.postCalculator,
          _assertThisInitialize2 = (0, _assertThisInitialized2["default"])(_this),
    ...
    _this.yAxisZoom = function (chartId, newDomain) {
      ...
      var initialChartConfig = _this.state.chartConfig,
          chartConfig = initialChartConfig.map(function (each) {
        if (each.id === chartId) {
    ...
    _this.panHelper = function (mouseXY, initialXScale, _ref, chartsToPan) {
      ...
      var _this$state5 = _this.state,
          ...
          postCalculator = _this.props.postCalculator,
          _assertThisInitialize3 = (0, _assertThisInitialized2["default"])(_this),
          fullData = _assertThisInitialize3.fullData,
    ...
    var _resetChart = (0, _ChartCanvasFn.resetChart)(_props),
        _fullData = _resetChart.fullData,
        _state = (0, _objectWithoutPropertiesLoose2["default"])(_resetChart, _excluded);

    _this.state = _state;
    _this.fullData = _fullData;
    return _this;
  }
  ...
  _proto.getChildContext = function getChildContext() {
    var _this$props5 = this.props,
        ...
        displayXAccessor = _this$state8.displayXAccessor,
  ...
  _proto.UNSAFE_componentWillReceiveProps = function UNSAFE_componentWillReceiveProps(nextProps) {
    ...
    var _this$state9 = this.state,
        initialChartConfig = _this$state9.chartConfig,
    ...
    var _newState = newState,
        ...
        state = (0, _objectWithoutPropertiesLoose2["default"])(_newState, _excluded2);
  ...
  _proto.render = function render() {
    var _this$props6 = this.props,
        ...
        chartConfig = _this$state10.chartConfig,
