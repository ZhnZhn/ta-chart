...
function _default(locale) {
  let group = locale.grouping === undefined || locale.thousands === undefined ? _identity.default : (0, _formatGroup.default)(map.call(locale.grouping, Number), locale.thousands + ""),
  ...
  function formatPrefix(specifier, value) {
    let f = newFormat((specifier = (0, _formatSpecifier.formatSpecifier)(specifier), specifier.type = "f", specifier)),
