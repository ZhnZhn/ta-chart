...
timeYear.every = k => !isFinite(k = mathFloor(k)) || !(k > 0) ? null : (0, _interval.timeInterval)(date => {
...
utcYear.every = k => !isFinite(k = mathFloor(k)) || !(k > 0) ? null : (0, _interval.timeInterval)(date => {
