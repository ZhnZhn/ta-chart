export const getClosestItemIndexes = (
  array,
  value,
  accessor
) => {
   ...
   , highItemValue = accessor(array[hi]);
...
export const getClosestItem = (
  ...
  accessor
   ...
   , closest = Math.abs(leftItem.valueOf() - value.valueOf()) < Math.abs(rightItem.valueOf() - value.valueOf())
       ? array[left]
       : array[right];
   return closest;
};
